...
public class MyList<Integer> extends ArrayList<Integer> {
    ...
    public boolean add(Integer integer){
        if(!super.contains(integer)){differentElements++;}
        boolean res=super.add(integer);
        if(res==false){differentElements--;}
        return res;
    }
    ...
    public Integer remove(int index){
        Integer integer=super.get(index);
        super.remove(index);
        if(!super.contains(integer)){differentElements--;}
        return integer;
    }
    ...
    public boolean remove(Object i){
        ...
        boolean res=super.remove(integer);
        if(!super.contains(integer)){differentElements--;}
        return res;
    }
