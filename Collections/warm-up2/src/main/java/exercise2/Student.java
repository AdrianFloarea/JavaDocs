...
public class Student {
    ...
    public String toString() {
        return id + " " + firstName + " " + lastName + " " + "average grade:" + averageGrade + "\n";
    }
    ...
    public boolean equals(Object o) {
        ...
        if (o != null) {
            ...
            if (o instanceof Student) {
                ...
                if (this.getId() == student.getId() && this.getFirstName().equals(student.getFirstName()) && this.getLastName().equals(
                        student.getLastName()
                ) && this.getAverageGrade().equals(student.getAverageGrade())) {
                    return true;
                }
            }
        }
    ...
    @Override
    public int hashCode() {
        return 31*id+firstName.hashCode()+7*lastName.hashCode()-averageGrade.hashCode();
